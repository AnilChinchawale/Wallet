...
<title>asw.xinfin.org</title>
<meta property="og:title" content="asw.xinfin.org: Your Key to Ethereum">
...
<link href="images/fav/apple-icon-180x180.png" rel="apple-touch-icon" sizes="180x180">
  ...
  <section class="container">
    @@if (site === 'mew' ) {
      <a class="brand" href="/" aria-label="Go to homepage">
        <img src="images/xinfinewallet_transparent.png"   height="64px" width="245px" alt="MyEtherWallet" />
