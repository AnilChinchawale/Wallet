...
<head>
  ...
  <link rel="icon" type="image/png" href="images/fav/android-icon-96x96.png" sizes="96x96">
  <link rel="icon" type="image/png" href="images/fav/android-icon-192x192.png" sizes="192x192">
